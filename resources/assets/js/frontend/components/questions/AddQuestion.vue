<template>
    <div class="col-md-12 mb-2">
        <ul class="nav nav-tabs" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#translator" role="tab" aria-controls="profile">Translator</a>
            </li>
        </ul>
        <div class="tab-content">
            ...
            <div class="tab-pane" id="translator" role="tabpanel" style="overflow:hidden">
                <div class="col-md-6"  style="float:left;">
                    <select name="from" v-model="from" class="form-control">
                ...
                <div class="col-md-6" style="float:left;">
                    <select name="to" v-model="to" class="form-control">
                        <option value="">Country...</option>
                        <option value="AF">Afghanistan</option>
                        <option value="AL">Albania</option>
                        <option value="DZ">Algeria</option>
                ...
                <div class="col-md-6" style="float:left;">
                    <textarea name="" v-model="message" cols="30" rows="10" style="width: 100%;"></textarea>
                </div>
                <div class="col-md-6" style="float:left;">
                    <textarea name="" v-model="response" cols="30" rows="10" style="width: 100%;"></textarea>
                </div>
                <div style="clear:both;"></div>
                <div class="col-md-12">
                    <button class="btn full-width btn-success" v-on:click="translate()">Translate</button>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            async translate() {
                const response = await API.Google.translate({
                    from: this.from,
                    to: this.to,
